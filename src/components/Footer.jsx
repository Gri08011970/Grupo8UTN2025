    ...
    <footer className="mt-12 border-t bg-white">
      <div className="container mx-auto max-w-6xl px-4 py-6 text-sm text-gray-600 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="order-1 md:order-2 flex items-center gap-4">
          ...
          />
          <span>
            ♥ Integrantes:   <span className="text-pink-600" aria-hidden></span>  Axel Chamorro · Magalí Izaurralde · Diego Farias· Daniela Ávalos · Mauro Britez . Leandro .  Griselda Molina./ Profesor Axel Leonardi
          </span>
        </div>
      </div>
    </footer>
